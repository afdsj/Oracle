...
INSERT --필드의 값을 넣을때 사용 INSERT, INTO
    INTO USER_NOTNULL
(
    USER_NO, USER_ID, USER_PWD
    , USER_NAME, GENDER, PHONE
...
SELECT
 ...
 WHERE UC.CONSTRAINT_NAME = UCC.CONSTRAINT_NAME
   AND UCC.CONSTRAINT_NAME = 'SYS_C008368'; --제약조건의 이름 sys어쩌구
...
-- CHECK 제약 조건 : 컬럼에 들어가는 값에 비교연산을 이용해 조건을 만족하는 경우에만 
